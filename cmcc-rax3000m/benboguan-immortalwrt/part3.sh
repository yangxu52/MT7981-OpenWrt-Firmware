...
sed -i 's/ssid="ImmortalWrt-2.4G"/ssid="RAX3000M-2.4G"/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ssid="OpenWRT-2.4G/ssid="RAX3000M-2.4G/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mtk.sh
echo '=========Alert 2.4G wifi name OK!========='

echo '修改闭源驱动5G wifi名称'
sed -i 's/ssid="ImmortalWrt-5G"/ssid="RAX3000M-5G"/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ssid="OpenWRT-5G/ssid="RAX3000M-5G/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mtk.sh
